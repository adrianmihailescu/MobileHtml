...
Sub Display()
	...
	If g_strKeyword <> "" Then
		If g_strContext <> "" Then
			Call Goodies_Init( IMODE_DISPLAY_KEY_SCREENS, null, null )
...
<html>
	<head>
		...
		<tr>
			<td>&#59115; <a href="default2.asp?uid=UIDREQUEST&ref=<%=g_strReferer%>" accesskey="0">Home KiweeScreens</a></td>
		</tr>
	</table>
	</body>
</html>
