	...
	If strContentGroup <> "" Then
		If Subscription_SelectDownloadsByContentType( Common_GetUID(), strContentGroup, strContentType, Null, l_objRs ) Then
				...
				For l_lngIdx = l_lngItem To l_lngItem + g_lngContentPerPage - 1
					...
					l_strXML = ""
					Call Goodies_Init( IMODE_DISPLAY_KEY_SCREENS, l_objRs("ContentGroup"), l_objRs("ContentType") )
			...
			Else
				...
				Case GOODIE_CONTENTTYPE_ANIM_COLOR
					l_strHTML = "<tr><td align='left'>Non hai ancora scaricato nessuna animazione.<br>Ritrova nella tua zona personale tutte le animazioni che tu hai scaricato su KiweeScreens.</td></tr>" & vbCrLf
				Case GOODIE_CONTENTTYPE_VIDEO_SSAVER
					l_strHTML = "<tr><td align='left'>Non hai ancora scaricato nessuno video.<br>Ritrova nella tua zona personale tutti i video che tu hai scaricato su KiweeScreens.</td></tr>" & vbCrLf
				Case Else
					l_strHTML = "<tr><td align='left'>Non hai ancora scaricato nessuno sfondo.<br>Ritrova nella tua zona personale tutti gli sfondi che tu hai scaricato su KiweeScreens.</td></tr>" & vbCrLf
				End Select
			End If
...
<div align="center"> <img src="../images/screenssmall<% = Common_GetMobileWidth() %>.gif" alt="Kiwee Screens"><br>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr bgcolor="#FFFFFF"> 
      <td>
        <div align="center"><font color="#FF3333">Zona personale</font></div>
      </td>
    </tr>
  </table>
...
<% If Not Subscription_IsUIDSubscribed( Common_GetUID() ) Then %>
	<tr>
		<td>
			Tutti i prodotti kiweescreens che scarichi restano sempre disponibili in questa zona, a volont&agrave;!
			<br>
		</td>
	</tr>	
<% Else
