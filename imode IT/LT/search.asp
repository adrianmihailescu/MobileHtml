...
Sub Display()
	...
	If g_strKeyword <> "" Then
		If g_strContext <> "" Then
			Call Goodies_Init( IMODE_DISPLAY_KEY_LT, null, null )
...
<html>
	<head>
		...
		<div align="center"><img src="/images/lt<% = Common_GetMobileWidth() %>.gif" alt="Looney Tunes" /><br>
		...
		<tr>
			<td>&#59115; <a href="default2.asp?uid=UIDREQUEST&ref=<%=g_strReferer%>" accesskey="0">Looney Tunes HomePage</a></td>
		</tr>
	</table>
	</body>
</html>
