...
Sub GetExtendedTicketFile()
	...
	If Goodies_GetContentTicketFileEx( bk, Server.URLEncode("HB" & g_strNav), g_lngIDContent, Common_GetMobileType(), l_strXML) Then
...
Sub GetExtendedTicket()
	...
	If Goodies_GetContentTicketExtended( bk, Server.URLEncode("Hb" & g_strNav), g_lngIDContent, Common_GetMobileType(), l_strXML) Then
		Set l_objXML = Server.CreateObject("MSXML2.DomDocument")
		l_objXML.loadXML l_strXML
