...
Sub Page_Initialize()
	...
	Call Subscription_Init( Common_GetConnectionString(), "HB" )
...
Sub Check()
	...
	Else
			g_strURLDownload = Common_GetUrlBillingHb("reg")
			g_strUrlDownload2 = IMODE_URL_ACTE & "?ci=" & id_PPE & "&uid=UIDREQUEST&nl_ok=" & Server.HTMLEncode("http://" & Request.ServerVariables("HTTP_HOST") & "/hb/download2.asp") & "&nl_ko=" & Server.HTMLEncode("http://" & Request.ServerVariables("HTTP_HOST") & "/hb/default2.asp") & "&act=SAP&arg1=" & g_lngIDContent & "&arg2=" & g_strContentGroup
...
<div align="center"><img src="/images/hb<% = Common_GetMobileWidth() %>.gif" alt="Kiweescreens" /></div>
