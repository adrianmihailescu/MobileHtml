...
namespace wap
{
	...
	/// </summary>
	public class promobranded : CatalogBrowsing
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(_idContent > 0)
			{
				...
				catch(Exception caught)
				{
					...
					Log.LogError(String.Format(" Unexpected exception in EMOCION --> emocion.kiwee.com\\wap\\promobranded.aspx - UA : {0} - QueryString : {1}", Request.UserAgent, Request.ServerVariables["QUERY_STRING"]), caught);
