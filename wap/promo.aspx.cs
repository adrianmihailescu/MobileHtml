...
namespace wap
{
	...
	/// </summary>
	public class promo : CatalogBrowsing
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(_idContent > 0)
			{
				...
				catch(Exception caught)
				{
					...
					Log.LogError(String.Format(" Unexpected exception in EMOCION --> emocion.kiwee.com\\wap\\promo.aspx - UA : {0} - QueryString : {1}", Request.UserAgent, Request.ServerVariables["QUERY_STRING"]), caught);
