...
namespace xhtml
{
	public class animation : XCatalogBrowsing
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(_idContent > 0)
			{
				...
				catch(Exception caught)
				{
					...
					Log.LogError(String.Format("Site emocion : Unexpected exception in emocion\\xhtml\\animation.aspx - UA : {0} - QueryString : {1}", Request.UserAgent, Request.ServerVariables["QUERY_STRING"]), caught);
