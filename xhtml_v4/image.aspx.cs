...
namespace xhtml
{
	public class image : XCatalogBrowsing
	{
...
//								}					
				...
				catch(Exception caught)
				{
					...
					Log.LogError(String.Format("Site emocion : Unexpected exception in emocion\\xhtml\\image.aspx - UA : {0} - QueryString : {1}", Request.UserAgent, Request.ServerVariables["QUERY_STRING"]), caught);
