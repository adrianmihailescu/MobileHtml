...
<%@ Page language="c#" Codebehind="error.aspx.cs" AutoEventWireup="false" Inherits="xhtml.error" %>
  ...
  <head>
          ...
          <body>
                    <a id="start" name="start" />
                     ...
                     <Xhtml:XhtmlTable id="tbError" Runat="server" CssClass="normal">
						<Xhtml:XhtmlTableRow id="rowError" Runat="server" />
						<Xhtml:XhtmlTableRow id="rowError2" Runat="server" />
                    </Xhtml:XhtmlTable>   
					<hr />
                   <table width="100%">
						<tr>
					...
					<p style="text-align:center; height:110%; background-repeat: no-repeat; background-position: top center; background-image:	url(<%=fondo%>); "> 
						...
						<a href="./default.aspx" class="imagen"><img src="<%=back%>" alt="" border="0"></a>&nbsp;
